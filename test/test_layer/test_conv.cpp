...
TEST(test_layer, conv3x3x32_stride1x1_padding0) {
...
TEST(test_layer, conv3x3x32_stride1x1_padding2) {
  const uint32_t batch = 8;
  std::vector<sftensor> inputs(batch);
  std::vector<sftensor> outputs1(batch);
  std::vector<sftensor> outputs2(batch);
...
TEST(test_layer, conv3x3x32_stride2x2_padding2) {
  const uint32_t batch = 8;
  std::vector<sftensor> inputs(batch);
  std::vector<sftensor> outputs1(batch);
  std::vector<sftensor> outputs2(batch);
...
TEST(test_layer, conv3x3x32_stride5x5_padding2) {
  const uint32_t batch = 8;
  std::vector<sftensor> inputs(batch);
  std::vector<sftensor> outputs1(batch);
  std::vector<sftensor> outputs2(batch);
...
TEST(test_layer, conv5x5x32_stride5x5_padding2) {
  const uint32_t batch = 8;
  std::vector<sftensor> inputs(batch);
  std::vector<sftensor> outputs1(batch);
  std::vector<sftensor> outputs2(batch);
...
TEST(test_layer, conv5x5x32_stride7x7_padding2) {
  const uint32_t batch = 8;
  std::vector<sftensor> inputs(batch);
  std::vector<sftensor> outputs1(batch);
  std::vector<sftensor> outputs2(batch);
...
TEST(test_layer, conv13x13x32_stride7x7_padding2) {
  const uint32_t batch = 8;
  std::vector<sftensor> inputs(batch);
  std::vector<sftensor> outputs1(batch);
  std::vector<sftensor> outputs2(batch);
...
TEST(test_layer, conv13x13x31_stride19x19_padding2) {
  const uint32_t batch = 8;
  std::vector<sftensor> inputs(batch);
  std::vector<sftensor> outputs1(batch);
  std::vector<sftensor> outputs2(batch);
