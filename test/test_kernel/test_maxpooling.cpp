#include "../../src/kernel/details/maxpooling.hpp"
...
TEST(test_kernel, forward_max_pooling_s11_k33) {
...
TEST(test_kernel, forward_max_pooling_s11_k33_p1) {
  std::vector<sftensor> inputs;
...
TEST(test_kernel, forward_max_pooling_s22_k33) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
  const uint32_t kernel_h = 3;
...
TEST(test_kernel, forward_max_pooling_s33_k33) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
  const uint32_t kernel_h = 3;
...
TEST(test_kernel, forward_max_pooling_s11_k55) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
...
TEST(test_kernel, forward_max_pooling_s22_k55) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
  const uint32_t kernel_h = 5;
...
TEST(test_kernel, forward_max_pooling_s33_k55) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
  const uint32_t kernel_h = 5;
...
TEST(test_kernel, forward_max_pooling_s55_k55) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
  const uint32_t kernel_h = 5;
...
TEST(test_kernel, forward_max_pooling_s11_k77) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
...
TEST(test_kernel, forward_max_pooling_s22_k77) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
  const uint32_t kernel_h = 7;
...
TEST(test_kernel, forward_max_pooling_s33_k77) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
  const uint32_t kernel_h = 7;
...
TEST(test_kernel, forward_max_pooling_s55_k77) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
  const uint32_t kernel_h = 7;
...
TEST(test_kernel, forward_max_pooling_s77_k77) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
  const uint32_t kernel_h = 7;
