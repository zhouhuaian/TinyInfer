...
TEST(test_kernel, forward_hardswish1) {
  ...
  HardSwish hardswish;
  const auto status = hardswish.Forward(inputs, outputs);
...
TEST(test_kernel, forward_hardswish2) {
...
TEST(test_kernel, forward_hardswish3) {
