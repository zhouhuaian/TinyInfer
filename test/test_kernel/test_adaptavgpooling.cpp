#include "../../src/kernel/details/adapt_avgpooling.hpp"
...
TEST(test_kernel, forward_adapt_avgpooling_out1x1) {
...
TEST(test_kernel, forward_adapt_avgpooling_out3x3) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
...
TEST(test_kernel, forward_adapt_avgpooling_out3x3p1) {
  std::vector<sftensor> inputs;
...
TEST(test_kernel, forward_adapt_avgpooling_out5x5) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
...
TEST(test_kernel, forward_adapt_avgpooling_out7x7) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
...
TEST(test_kernel, forward_adapt_avgpooling_out9x9) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
...
TEST(test_kernel, forward_adapt_avgpooling_out11x11) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
...
TEST(test_kernel, forward_adapt_avgpooling_out1x11) {
  std::vector<sftensor> inputs;
  const uint32_t input_h = 224;
  const uint32_t input_w = 224;
  const uint32_t output_h = 1;
